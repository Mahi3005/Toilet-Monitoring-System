...
$attended = isset($_POST['attended']) ? $_POST['attended'] : '';
  ...
  //  $otp = str_pad(rand(0, 999999), 6, '0', STR_PAD_LEFT);
    ...
    //Content
        ...
        $mail->Subject = 'Concerns about Low Attendance';
        ...
        <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
        <tr>
        <td esdev-links-color="#000000" align="left" style="padding:0;Margin:0"><h5 style="Margin:0;font-family:"times new roman", times, baskerville, georgia, serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:normal;line-height:24px;color:#000">Dear Caretaker,</h5><h5 style="Margin:0;font-family:"times new roman", times, baskerville, georgia, serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:40px;font-style:normal;font-weight:normal;line-height:24px;color:#000">&nbsp;&nbsp;During our recent inspection of the toilet facility, we found that you were present on <br> <h3 style="color: crimson;"> ' .$attended. ' out of the 31 days.&nbsp;</h3></h5><h5 style="Margin:0;font-family:"times new roman", times, baskerville, georgia, serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:40px;font-style:normal;font-weight:normal;line-height:24px;color:#000">This level of attendance is unacceptable, and we expect immediate improvement.</h5><h5 style="Margin:0;font-family:"times new roman", times, baskerville, georgia, serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:normal;line-height:24px;color:#000">Please listen to the attached voice note for more details. We will monitor your attendance closely moving forward.<br><br></h5><h5 style="Margin:0;font-family:"times new roman", times, baskerville, georgia, serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:normal;line-height:24px;color:#000">Respectfully,</h5><h5 style="Margin:0;font-family:"times new roman", times, baskerville, georgia, serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:normal;line-height:24px;color:#000">Gandhinagar Municipal Corporation</h5></td>
        </tr>
        </table></td>
        </tr>
        </table></td>
