...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Get the email and OTP from the POST request
    $email = $_POST['email'];
    $otp = $_POST['otp'];

    // Perform email sending logic here (e.g., using PHPMailer)
    // Configure your email parameters (SMTP server, sender, recipient, subject, content, etc.)
    
    // Send the email with OTP
    if (sendEmailWithOTP($email, $otp)) {
        echo 'Email sent'; // Return a success message
    } else {
...
function sendEmailWithOTP($email, $otp) {
    ...
    try {
     ...
     //   $mail->addAttachment('C:\Users\Mihir\Downloads\GaneshaWallpaper\Lalbaugcha_RajaP9AR.jpg', 'BappaMorya.jpg');    //Optional name
        ...
        <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
        <tr>
        <td esdev-links-color="#000000" align="left" style="padding:0;Margin:0"><h5 style="Margin:0;font-family:"times new roman", times, baskerville, georgia, serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:normal;line-height:24px;color:#000">Dear User,&nbsp;</h5><h5 style="Margin:0;font-family:"times new roman", times, baskerville, georgia, serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:normal;line-height:24px;color:#000">Thank you for registering with us! In order to verify your email address, kindly utilize the One-Time Password (OTP) provided below. Please note that this OTP will be valid for a limited time, so we encourage you to use it promptly. Kindly click on the otp to copy it.<br> <h3 style="color: crimson;">OTP: <span id="otpDisplay">' . $otp . '</span>&nbsp;</h3><br></h5><h5 style="Margin:0;font-family:"times new roman", times, baskerville, georgia, serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:normal;line-height:24px;color:#000">If you did not initiate this verification process, please disregard this email.</h5><h5 style="Margin:0;font-family:"times new roman", times, baskerville, georgia, serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:normal;line-height:24px;color:#000"></h5><h5 style="Margin:0;font-family:"times new roman", times, baskerville, georgia, serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:normal;line-height:24px;color:#000">Best regards,</h5><h5 style="Margin:0;font-family:"times new roman", times, baskerville, georgia, serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:normal;line-height:24px;color:#000">Gandhinagar Municipal Corporation</h5></td>
        </tr>
        </table></td>
        </tr>
        </table></td>
