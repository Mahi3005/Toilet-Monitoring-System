...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['email'])) {
    $emailFromJS = $_POST['email'];
    // Now you can use this $emailFromJS as a PHP variable.
    // For example, you can store it in a session variable or process it further.
    session_start();
    $_SESSION['emailFromJS'] = $emailFromJS;
    echo "Email stored in PHP session successfully.";
    session_destroy();
}
...
try {
    ...
    $mail->addAddress($emailFromJS);            //Name is optional
