...
$email = 'dhruvvyas3005@gmail.com';
$toiletId = $_POST['toilet_id'];
$toiletCleaner = $_POST['toiletCleaner'];
$soap = $_POST['soap'];
$sanitizer = $_POST['sanitizer'];
  ...
  //  $otp = str_pad(rand(0, 999999), 6, '0', STR_PAD_LEFT);
    ...
    //Content
        ...
        $mail->Subject = 'Consumables Re-Order Email';
        ...
        <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
        <tr>
        <td esdev-links-color="#000000" align="left" style="padding:0;Margin:0"><h5 style="Margin:0;font-family:"times new roman", times, baskerville, georgia, serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:normal;line-height:24px;color:#000">Dear Consumable Supplier,</h5><h5 style="Margin:0;font-family:"times new roman", times, baskerville, georgia, serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:40px;font-style:normal;font-weight:normal;line-height:24px;color:#000"><br>&nbsp;I hope this message finds you well. We would like to request a re-order of consumable items for the toilet facilities to ensure that we maintain a clean and hygienic environment for our users.<br> Here are the details of the consumables that need to be replenished:<span  style="color: crimson; font-size: large;"><br><br>Toilet_Id: ' . $toiletId . '<br>
        Toilet cleaner quantity: ' . $toiletCleaner . '<br>
        Soap quantity: ' . $soap . '<br>
        Sanitizer quantity: ' . $sanitizer .'<br>&nbsp;</span><br>Please be assured that your concern has been duly noted and is currently being reviewed by our administrative team.<br> <br>We understand the importance of a properly functioning restroom facility, and we are committed to resolving this matter promptly. Our team is diligently working to assess the situation and implement the necessary measures to address the issue at the earliest.</h5><h5 style="Margin:0;font-family:"times new roman", times, baskerville, georgia, serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:40px;font-style:normal;font-weight:normal;line-height:24px;color:#000">We kindly request your assistance in arranging the procurement of the above-mentioned items to avoid any inconvenience for our users.<br>
                Please let us know the estimated time for delivery and any further instructions for the re-order process.</h5><h5 style="Margin:0;font-family:"times new roman", times, baskerville, georgia, serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:normal;line-height:24px;color:#000">Kind Regards,</h5><h5 style="Margin:0;font-family:"times new roman", times, baskerville, georgia, serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:normal;line-height:24px;color:#000">Gandhinagar Municipal Corporation</h5></td>
        </tr>
        </table></td>
        </tr>
        </table></td>
