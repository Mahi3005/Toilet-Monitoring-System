...
$email = isset($_POST['inspector_mail']) ? $_POST['inspector_mail'] : '';
$toilet_id = isset($_POST['toilet_id']) ? $_POST['toilet_id'] : '';
  ...
  //  $otp = str_pad(rand(0, 999999), 6, '0', STR_PAD_LEFT);
    ...
    //Content
        ...
        <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
        <tr>
        <td esdev-links-color="#000000" align="left" style="padding:0;Margin:0"><h5 style="Margin:0;font-family:"times new roman", times, baskerville, georgia, serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:normal;line-height:24px;color:#000">Dear User,</h5><h5 style="Margin:0;font-family:"times new roman", times, baskerville, georgia, serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:40px;font-style:normal;font-weight:normal;line-height:24px;color:#000"><br>&nbsp;We acknowledge the receipt of your complaint regarding the issue with the toilet having ID <span  style="color: crimson; font-size: large;"> '.$toilet_id. '&nbsp;</span> <br><br>Please be assured that your concern has been duly noted and is currently being reviewed by our administrative team.<br> <br>We understand the importance of a properly functioning restroom facility, and we are committed to resolving this matter promptly. Our team is diligently working to assess the situation and implement the necessary measures to address the issue at the earliest.</h5><h5 style="Margin:0;font-family:"times new roman", times, baskerville, georgia, serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:40px;font-style:normal;font-weight:normal;line-height:24px;color:#000">If you have any further questions or require additional information, please feel free to reach out to us. <br>
            Thank you for bringing this matter to our attention. We apologize for any inconvenience this may have caused and appreciate your cooperation.</h5><h5 style="Margin:0;font-family:"times new roman", times, baskerville, georgia, serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:normal;line-height:24px;color:#000"><br>Best Regards,</h5><h5 style="Margin:0;font-family:"times new roman", times, baskerville, georgia, serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:normal;line-height:24px;color:#000">Gandhinagar Municipal Corporation</h5></td>
        </tr>
        </table></td>
        </tr>
        </table></td>
